    ...
    <main class=" mx-auto flex flex-col lg:flex-row gap-16 items-start p-3 md:p-14 bg-[#EEEEEE33]">
        <section class="flex-1 lg:px-0 w-full">
            <div class="flex flex-col w-full">
                <div class="">
                    <div class="">
                        <FinalFormStepper :steps="['Bike Owner Details', 'Nominee Details', 'Other Details']"
                            :currentStep="currentStep" />
                    </div>
                    <div v-if="currentStep === 1">
                        <FinalFormBikeOwnerDetail @next="goToStep(2)" />
                    </div>
                    <div v-else-if="currentStep === 2">
                        <FinalFormBikeOwnerNominee :members="members" @next="goToStep(3)" />
                    </div>
                    <div v-else-if="currentStep === 3">
                        <FinalFormBikeOtherDetail />
                    </div>
                </div>
            ...
            <div
                ...
                <div class=" px-2 py-1">
                    ...
                    <div class="flex items-center justify-between px-2">
                        <div class="">
                            <span class="text-[#000000] font-semibold text-[15px]">CB Shine </span>
                            <div class="flex items-center gap-2 text-[#000000] font-semibold text-[10px]">
                                <span>2020</span>
                                <span>Kick Start Drum Brake Spoke WheelsCBS (110)</span>
                            </div>
                        </div>
                        <div class="">
