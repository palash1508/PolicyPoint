<template>
    <div class="min-h-screen bg-gray-100">
        ...
        <header class="px-9 py-6 bg-[#EEEEEE33] shadow flex justify-between items-center">
            <div>
                <h1 class="text-2xl md:text-[40px]  font-semibold text-[#2B2B5F]">Travel Insurance</h1>
                <p class="text-[#000000] text-[25px] leading-[40px] font-medium">Discover the Best Travel Insurance Plans Customized for Your Journey!</p>
            </div>
        ...
        <main class=" mx-auto flex flex-col lg:flex-row gap-8 mt-2">
            ...
            <section class="flex-1 px-2 lg:px-0 lg:pr-3 pb-3">
                <h2 class="text-3xl font-semibold text-[#2B2B5F] mt-4 mb-4">We found {{ travelPlans.length }} plans for you</h2>

                <!-- Cards -->
                <div class="space-y-4">
                    <InsuranceTravelPlansCard v-for="(plan, index) in travelPlans" :key="index" :plan="plan" />
                </div>
            </section>
        </main>
    </div>
