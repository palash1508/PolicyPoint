<template>
    <div class="min-h-screen bg-gray-100">
        ...
        <header class="px-9 py-6 bg-[#EEEEEE33] shadow flex justify-between items-center">
            <div>
                <h1 class="text-2xl md:text-[40px]  font-semibold text-[#2B2B5F]">Car Insurance</h1>
                <p class="text-[#000000] text-[25px] leading-[40px] font-medium">Discover the Best Car Insurance Plans Customized for Your Vehicle!</p>
            </div>
        ...
        <main class=" mx-auto flex flex-col lg:flex-row gap-8 mt-2">
            ...
            <aside class="w-full lg:w-1/5 p-10 border-r-2">
                <div class="mb-6">
                    ...
                    <div class="border bg-[#FFFFFF] border-[#2B2B5F] w-full py-4 px-6 flex flex-col gap-1 rounded-lg -mt-3 z-0">
                        <div class="text-[#000000] font-semibold text-[15px]">Tata Nexon </div>
            ...
            <section class="flex-1 px-2 lg:px-0 lg:pr-3 pb-3">
                <h2 class="text-3xl font-semibold text-[#2B2B5F] mt-2 mb-4">{{ carZeroDepPlans.length }} Zero Dep plans Found</h2>

                <!-- Cards -->
                <div class="space-y-4">
                    <InsuranceCarPlansCard v-for="(plan, index) in carZeroDepPlans" :key="index" :plan="plan" />
                </div>
                
                <h2 class="text-3xl font-semibold text-[#2B2B5F] mt-4 mb-4">We found {{ carPlans.length }} plans for you</h2>

                <!-- Cards -->
                <div class="space-y-4">
                    <InsuranceCarPlansCard v-for="(plan, index) in carPlans" :key="index" :plan="plan" />
                </div>
            </section>
        </main>
    </div>
