<template>
    <div
        ...
        <div>
            <img src="/public/assets/images/Insurance/Car_Cvr_3.png" alt="">
        </div>
        <div class="w-full md:w-[522px]">
            <div class="flex flex-col">
                <span class="text-[#999999] px-1 font-bold text-xs">Welcome To Policy Point</span>
                <span class="text-[#2B2B5F] text-xl lg:text-[30px] lg:leading-[40px] font-bold">Protection That Moves With You</span>
